...
<div class="row justify-content-center">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<h5>Hi <strong><?php echo e(Auth::user()->name); ?>,</strong> <?php echo e(__('You are logged in to ')); ?><?php echo e(config('app.name', 'Laravel')); ?></h5>
				</br>
				<hr>
			...
			<div class="row w-100">
					...
					<div class="col-md-3">
						<div class="card border-warning mx-sm-1 p-3">
							...
							<div class="text-warning text-center mt-2"><h1><?php echo e(Auth::user()->count()); ?></h1></div>
						</div>
					</div>
				 </div>
			</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\example-app\resources\views/home.blade.php ENDPATH**/ ?>